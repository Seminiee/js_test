...
- Section 9 229 (`this` 소개) && Section 9 230 (메서드 축약어 구문)
...
- Section 10 241 (OOP 코드로 시작하기)
- Section 10 242 (첫 번째 클래스 정의 & 사용하기)
- Section 10 243 (생성자 메서드로 작업하기)
- Section 10 244 (필드 vs 프로퍼티)
- Section 10 245 (다수의 클래스 사용하고 연결하기)
- Section 10 246 (클래스 메서드 바인딩하고 `this`로 작업하기)
- Section 10 247 (장바구니"Cart"와 Shop 클래스 추가하기)
